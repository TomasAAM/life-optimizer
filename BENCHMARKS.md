...
| **Threshold** (LT2 proxy) | **30-min TT** (Friel): avg HR of last 20 min ≈ LTHR, avg pace ≈ threshold pace. Same route, fresh. | **4:10/km @ 178 bpm** (derived 2026-09-22 from the pace–HR curve, two 10 km races and the 09-22 threshold reps; supersedes 4:16 @ 175 and the 2026-06-19 lab pair) | push pace down at same HR | The ceiling both the 21k and Hyrox running share — re-check so zones don't drift. Lab lactate not repeated (access/cost); field TT keeps it current. |
...
| 2026-09-22 | Endurance | LT2 (re-anchor) | 4:10 @ 178 | /km @ bpm | Derived, not tested. Pace–HR curve + 08-30 and 09-13 10 km races + 08-11 TT (HR half) + 09-22 3×8 min reps | The curve (6:02→133, 5:05→154, 3:58→183, ~2.3 s/km per bpm) gives 4:10 at 178 from either end. Two ~40 min races averaged HR 183 and 181 (≈1–2% above LTHR); the naive TT last-20 was 179.6. On 09-22, 4:12/km held steady at avg HR 174 while 4:09/km drifted 177→181 within the rep. Supersedes 4:16 @ 175, which assumed LTHR = 175. Keep confirming from steady threshold reps. |
